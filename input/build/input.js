...
/***/ function(module, exports, __webpack_require__) {
	...
	var InputLiv = _react2.default.createClass({
	    displayName: "InputLiv",
	    ...
	    regularVerification: function regularVerification(reg) {
	        var doc = document,
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            "div",
	            { className: "input-liv" },
	            this.init().labelName == "" ? _react2.default.createElement("label", { forHtml: this.init().ids, className: "input-liv-label hidden", id: this.init().ids + "-label" }) : _react2.default.createElement(
	                "label",
	                { forHtml: this.init().ids, className: "input-liv-label", id: this.init().ids + "-label" },
	                this.init().labelName
	            ),
	            _react2.default.createElement(
	                "div",
	                { className: "input-liv-package" },
	                _react2.default.createElement("input", { type: "text", className: "input-liv-inp", id: this.init().ids, onBlur: this.blur, onFocus: this.focus }),
	                _react2.default.createElement(
	                    "div",
	                    { className: "input-liv-error hidden" },
	                    _react2.default.createElement("img", { src: "./img/warning.png" }),
	                    _react2.default.createElement("span", null)
	                )
	            ),
	            this.init().verifiCode == "" ? _react2.default.createElement("div", { className: "input-liv-verifiCode hidden" }) : _react2.default.createElement(
	                "div",
	                { className: "input-liv-verifiCode" },
	                _react2.default.createElement("img", { src: this.init().verifiCode })
	            )
	        );
	    }
	});

	exports.default = InputLiv;
